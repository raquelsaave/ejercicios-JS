...
window.onload = () => {
  ...
  const element7 = document.querySelector('#div6 .a-span');
  ...
  const element8 = document.querySelector('#div7');
  const element9 = document.querySelector('#div7 .a-span');
  ...
  const element10 = document.querySelectorAll('#div8 .a-span');
  element10.forEach((v, i) => { v.innerHTML = i + 1; })
  // Agrega un listener de click al primer y ultimo span de div9
  const element11 = document.querySelector('#div9 .a-span');
  const element12 = document.querySelector('#div9 .a-span:last-of-type');
  ...
  const element13 = document.querySelectorAll('#div10 .a-span');
  ...
  const element15 = document.querySelector('#div12 img').src = "puppy-3.png";
  // Pon 'THE-span' como id del span de div13
  const element16 = document.querySelector('#div13 span').id = "THE-span";
  /**
   ...
   */
  const element18 = document.querySelector('#div15 .a-span')
   ...
   */
  const element19 = document.querySelector('#div16')
